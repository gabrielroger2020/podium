...
export default function Teams (){
    ...
    let keywordView = "viewTeams";
    let keywordDel = "delTeams";
    let keywordAdd = "addTeams";
    let keywordEdit = "editTeams";
    let keywordManagers = "managersTeams";
    let keywordAthletes = "athletesTeams";
            ...
            if(response.data.length > 0){
                ...
                response.data.forEach((team)=>{
                    ...
                    <Button onClick={()=>{
                        ...
                        modalManagersHandlers.open();
                    }}leftSection={<IconUsersGroup></IconUsersGroup>} color="blue" disabled={!rkeywordManagers}>Gerentes</Button>
                    <Button onClick={()=>{
                        setSelectedTeam(team.id);
    ...
    useEffect(()=>{
        getTeams();
     },[rkeywordAdd,rkeywordDel,rkeywordEdit,rkeywordView, rkeywordManagers, rkeywordAthletes])
